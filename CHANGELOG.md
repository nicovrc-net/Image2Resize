...
## 1.2.0 (2026/7/1)
- gzip圧縮及びbrotli圧縮を対応を取りやめ
- 内部リファクタリング

## 1.2.0-beta.2 (2025/09/11)
- gzip圧縮及びbrotli圧縮に対応
- バグ修正

## 1.2.0-beta.1 (2025/08/15)
- 内部処理リファクタリング
...
## 1.1.1 (2025/07/18)
- Redisの接続にSSLを使用できるように

## 1.1.0 (2025/02/20)
- HTMLのog:imageがある場合その画像をもってくるようにした

## 1.1.0-beta.2 (2025/02/20)
- 画像以外やエラーになった取得先を一時的にキャッシュするようにする
